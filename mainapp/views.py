...
class ChangeQTYView(CartMixin, View):
    def post(self, request, *args, **kwargs):
        ...
        cart_product.save()
        recalc_cart(self.cart)
        messages.add_message(request, messages.INFO, 'Кол-во успешно измененно')
        return HttpResponseRedirect('/cart/')
...
class CheckoutView(CartMixin, View):
    def get(self, request, *args, **kwargs):
        stripe.api_key = 'sk_test_51HdwR3GtLuF9ywSUrYPTZjAOb6QUq2rM6F0YZPRRBrrfh1WnOKMVx6lYdIAeTSIRVDwBYPmRNZoEyyNFzwQuZqUV00M18CHXlg'
